...
# model.ckpt-299430
export BERT_BASE_DIR=/mnt/fs5/anie/gs_twitterbert/twitter-bert/char_bert_base_2019_june20_no_2017_04_sent_level_epoch25_char_40_word_60_tpuv2_256/
...
python3.6 run_validation.py \
  ...
  --max_seq_length=300 \
  --eval_batch_size=32 \
  --output_dir=/mnt/fs5/anie/twitter-bert-evals/social_edge_pred/char40_word60_bert/ \
  --log_file
